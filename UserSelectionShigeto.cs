...
public class UserSelectionShigeto : MonoBehaviour
{
    ...
    /// Not integrated 3/31
    /// </summary>
    // Therapist Panel for objects placement
    public GameObject TherapistContentsPlacementPanel;
    ...
    void Start()
    {
        ...
        /// Not integrated 3/31
        /// </summary>
        // deactivate objects placement panel
        if (TherapistContentsPlacementPanel != null) TherapistContentsPlacementPanel.SetActive(false);
    ...
    void UpdateUserSelection(string userType)
    {
        if (userType == "Therapist")
        {
            ...
            /// Not integrated 3/31
            /// </summary>
            TherapistContentsPlacementPanel.SetActive(true);
        }
